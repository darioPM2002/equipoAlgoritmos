...
void longestCommonSubstring(const string &s1, const string &s2)
{
  ...
  int maxPosS1 = -1; // Posición inicial del LCS en s1 (relativa a s1)
  int maxPosS2 = -1; // Posición inicial del LCS en s2 (relativa a combined)
  ...
  cout << "La posición de inicio y fin en el primer archivo de transmisión es " << maxPosS1 + 1 << " y " << maxPosS1 + maxLen << " respectivamente" << endl;
  cout << "La posición de incio y fin en el segundo archivo de transmisión es " << startS2_in_S2 + 1 << " y " << startS2_in_S2 + maxLen << ", respectivamente" << endl;
}